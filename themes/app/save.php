      ...
      <form action="#">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="email" placeholder="Escreva o email" required>
            <i class="icone fas fa-check-circle "></i>
            <i class="fas fa-exclamation-circle"></i>
            <small>Mensagem de erro</small>
          </div>
          <div class="input-box">
            <span class="details">CPF</span>
            <input type="number" placeholder="Digite o CPF" required>
            <i class="fas fa-check-circle"></i>
            <i class="fas fa-exclamation-circle"></i>
            <small>Mensagem de erro</small>
          </div>
          <div class="input-box">
            ...
            <input type="number" placeholder="Digite o número do celular" required>
            <i class="fas fa-check-circle"></i>
            <i class="fas fa-exclamation-circle"></i>
            <small>Mensagem de erro</small>
          </div>
