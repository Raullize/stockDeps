        ...
        <div class="modal-content">
            ...
            <form id="formAdicionarFornecedor">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="logradouroFornecedor" class="form-label">Logradouro</label>
                        <input type="text" class="form-control" id="logradouroFornecedor" placeholder="Digite o logradouro" required>
                    </div>
                    <div class="mb-3">
                        <label for="numeroFornecedor" class="form-label">Número</label>
                        <input type="text" class="form-control" id="numeroFornecedor" placeholder="Digite o número" required>
                    </div>
                </div>
